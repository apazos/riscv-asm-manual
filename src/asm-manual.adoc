...
This manual covers the standard RISC-V assembly language, supported by
open-source assemblers like GNU as and LLVM’s assembler, whose common options are
well-described in the binutils documentation. For more details on
...
please refer to the binutils user guide.
Enhancing the binutils documentation is more effective than duplicating it here.
